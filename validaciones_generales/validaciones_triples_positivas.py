...
def validacion_triple_general(base_de_datos, dato_uno, dato_dos, dato_tres):
    ...
    if isinstance(dato_uno, str) and isinstance(dato_dos, str) and isinstance(dato_tres, str):
        validacion_triple_tree_str(coleccion,campos, base_de_datos, dato_uno, dato_dos, dato_tres)
        ...
        validacion_triple_two_str(coleccion,campos, base_de_datos, dato_uno, dato_dos, dato_tres)
...
def validacion_triple_tree_str(coleccion,campos, base_de_datos, dato_uno, dato_dos, dato_tres):
    for  campo_uno, campo_dos, campo_tres in permutations(campos, 3):
                ...
                if coleccion.find_one(query):
                    errores_triples.error_triple_positivo(base_de_datos, campo_uno, campo_dos,campo_tres, dato_uno, dato_dos, dato_tres)

    
def validacion_triple_two_str(coleccion,campos, base_de_datos, dato_uno, dato_dos, dato_tres):
    combinaciones_datos = [
