...
def view_podiums_season_by_id_season(router, base_de_datos, schema):
    ...
    async def show_podiums_season(dato:str, temporada:str):
        coleccion = getattr(db_client, base_de_datos)
        temporada_oid = funciones_logicas.validate_object_id(temporada)
        dict_dato, campo  =  buscar_data_team_or_driver(base_de_datos, dato, temporada_oid)
        ...
        primer_lugar, segundo_lugar, tercer_lugar, podios =  buscar_podios(carreras_totales, puntos_por_posicion, base_de_datos)
        podios_piloto =  transformacion(base_de_datos, podios, dict_dato, primer_lugar, segundo_lugar, tercer_lugar, dato, temporada_oid)
        print(carreras_totales)
        print(campo, dato)
